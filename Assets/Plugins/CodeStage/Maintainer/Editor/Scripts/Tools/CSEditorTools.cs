...
namespace CodeStage.Maintainer.Tools
{
	...
	internal static class CSEditorTools
	{
			...
			else
			{
				switch (sp.propertyType)
				{
					...
					case SerializedPropertyType.FixedBufferSize:
						...
						break;
					default:
						Debug.LogWarning(Maintainer.ConstructErrorForSupport("Unknown SerializedPropertyType: " + sp.propertyType));
						break;
				}
			}
		...
		public static EditorWindow GetInspectorWindow()
		{
			...
			{
				Debug.LogError(Maintainer.ConstructErrorForSupport("Can't find UnityEditor.InspectorWindow type!"));
				return null;
			}
			...
			{
				Debug.LogError(Maintainer.ConstructErrorForSupport("Can't get an InspectorWindow!"));
				return null;
			}
		...
		public static ActiveEditorTracker GetActiveEditorTrackerForSelectedObject()
		{
			...
			{
				Debug.LogError(Maintainer.ConstructErrorForSupport("Can't get ActiveEditorTracker from the InspectorWindow!"));
			}
		...
		public static bool RevealInSettings(AssetSettingsKind settingsKind, string path = null)
		{
			...
			switch (settingsKind)
			{
				...
				case AssetSettingsKind.NotSettings:
					Debug.LogWarning(Maintainer.ConstructLog("Can't open settings of kind NotSettings Oo"));
					result = false;
					break;
				case AssetSettingsKind.DynamicsManager:
					if (!CSMenuTools.ShowProjectSettingsPhysics())
					{
						Debug.LogError(Maintainer.ConstructErrorForSupport("Can't open Physics Settings!"));
						result = false;
					}
					break;
				case AssetSettingsKind.EditorBuildSettings:
					...
					{
						Debug.LogError(Maintainer.ConstructErrorForSupport("Can't open EditorBuildSettings!"));
						result = false;
					}
					break;
				case AssetSettingsKind.EditorSettings:
					...
					{
						Debug.LogError(Maintainer.ConstructErrorForSupport("Can't open Editor Settings!"));
						result = false;
					}
					break;
				case AssetSettingsKind.GraphicsSettings:
					...
					{
						Debug.LogError(Maintainer.ConstructErrorForSupport("Can't open GraphicsSettings!"));
						result = false;
					}
					break;
				...
				case AssetSettingsKind.Physics2DSettings:
					...
					{
						Debug.LogError(Maintainer.ConstructErrorForSupport("Can't open Physics2D Settings!"));
						result = false;
					}
					break;
				case AssetSettingsKind.ProjectSettings:
					...
					{
						Debug.LogError(Maintainer.ConstructErrorForSupport("Can't open Player Settings!"));
						result = false;
					}
					break;
				case AssetSettingsKind.PresetManager:
					...
					{
						Debug.LogError(Maintainer.ConstructErrorForSupport("Can't open Preset Manager!"));
						result = false;
					}
					break;
				...
				case AssetSettingsKind.TagManager:
					...
					{
						Debug.LogError(Maintainer.ConstructErrorForSupport("Can't open Tags and Layers Settings!"));
						result = false;
					}
					break;
				...
				case AssetSettingsKind.VFXManager:
					...
					{
						Debug.LogError(Maintainer.ConstructErrorForSupport("Can't open VFX Settings!"));
						result = false;
					}
					break;
