...
namespace CodeStage.Maintainer.Tools
{
	...
	internal static class CSSettingsTools
	{
		public static Object GetInSceneLightmapSettings()
		{
			...
			Debug.LogError(Maintainer.ConstructErrorForSupport("Can't retrieve LightmapSettings object via reflection!"));
			return null;
		}
		...
		public static Object GetInSceneRenderSettings()
		{
			...
			Debug.LogError(Maintainer.ConstructErrorForSupport("Can't retrieve RenderSettings object via reflection!"));
			return null;
		}
