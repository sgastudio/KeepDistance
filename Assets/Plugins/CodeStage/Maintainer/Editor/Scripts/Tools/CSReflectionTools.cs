...
/*#if UNITY_2018_2_OR_NEWER
		...
		public static void SetInspectorToDebug(SerializedObject serializedObject)
		{
			if (inspectorModeCachedSetter == null)
			{
				...
				if (pi != null)
				{
					...
					{
						Debug.LogError(Maintainer.ConstructErrorForSupport("Can't get the setter for the SerializedObject.inspectorMode property!"));
						return;
					}
				}
				else
				{
					Debug.LogError(Maintainer.ConstructErrorForSupport("Can't get the SerializedObject.inspectorMode property!"));
					return;
				}
			}
		...
		public static void BeginVerticalSplit(object spl, GUILayoutOption[] guiLayoutOptions)
		{
			...
			if (beginVerticalSplitMethodInfo == null)
			{
				Debug.LogError(Maintainer.ConstructErrorForSupport("Can't get SplitterGUILayout.BeginVerticalSplit method!"));
				return;
			}
		...
		public static void EndVerticalSplit()
		{
			...
			if (endVerticalSplitMethodInfo == null)
			{
				Debug.LogError(Maintainer.ConstructErrorForSupport("Can't get SplitterGUILayout.EndVerticalSplit method!"));
				return;
			}
		...
		public static UnityEventBase GetDummyEvent(SerializedProperty property)
		{
			...
			if (getDummyEventMethodInfo == null)
			{
				Debug.LogError(Maintainer.ConstructErrorForSupport("Can't get UnityEventDrawer.GetDummyEvent method!"));
				return null;
			}
		...
		public static FieldInfo GetFieldInfoFromProperty(SerializedProperty property, out Type type)
		{
			...
			if (getFieldInfoFromPropertyMethodInfo == null)
			{
				...
				{
					Debug.LogError(Maintainer.ConstructErrorForSupport("Can't find UnityEditor.ScriptAttributeUtility type!"));
					return null;
				}
